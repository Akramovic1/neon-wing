...
export const Leaderboard: React.FC = () => {
  ...
  if (!isSupabaseConfigured) {
    return (
      <div className="w-full bg-[#1a1a1a] rounded-2xl border border-dashed border-red-500/30 p-6 text-center">
        <WifiOff size={24} className="mx-auto mb-3 text-red-500/50" />
        <p className="text-xs text-red-400 uppercase tracking-widest font-black mb-2">Offline Mode</p>
        <p className="text-[10px] text-neutral-500">Connect to Supabase for rankings.</p>
      </div>
    );
  }
